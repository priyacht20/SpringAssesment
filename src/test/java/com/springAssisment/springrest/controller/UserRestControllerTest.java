...
class UserRestControllerTest {
	...
	void testGetUser() {
		...
		assertEquals(HttpStatus.FOUND, userController.getUserPosts().getResposeStatus());
	}
	...
	void testGetUserWithException() {
		...
		response.setMessage("Unique User Ids Found");	
		when(userService.getAllUser()).thenReturn(response);
		assertEquals(HttpStatus.NOT_FOUND, userController.getUserPosts().getResposeStatus());
	}
